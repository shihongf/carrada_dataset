...
class AnnotationTransformer:
    ...
    def to_rda(self):
        """
        Method to convert DOA-Doppler points to range-doppler-angle representation
        ...
        for point in self.points:
            ...
            doppler_coordinate = int(doppler_value / self.cls.DOPPLER_RES)
            doppler_coordinate += int(self.y_shape/2)
            transformed_annotations.append([range_coordinate, doppler_coordinate, angle_coordinate])
        return transformed_annotations
